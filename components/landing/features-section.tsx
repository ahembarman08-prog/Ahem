...
const features = [
  {
    ...
    description: "Stop manually doing the same work every day. We automate the tasks that eat up your time—data entry, scheduling, follow-ups—so you can focus on what matters.",
    visual: "ai",
  },
  {
    number: "02",
    title: "Generate More Leads",
    description: "Get qualified prospects interested in your business, automatically. Our system finds the right people, keeps them engaged, and tells you who's ready to buy.",
    visual: "deploy",
  },
  {
    number: "03",
    title: "Answer Customers Instantly",
    description: "Respond to customer questions 24/7 without hiring extra staff. Customers get answers right away. You get more satisfied clients and fewer missed opportunities.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Get a Professional Online Presence",
    description: "A beautiful website that works hard for you. It looks great, loads fast, and actually helps you sell. Built to convert visitors into customers.",
    visual: "security",
  },
];
    ...
    >
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            More Time. More Leads. More Sales.
            <br />
            <span className="text-muted-foreground">Without doing more work.</span>
          </h2>
        </div>
